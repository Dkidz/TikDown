...
import icon from "./assets/icon.png"; // Sesuaikan path dengan lokasi file kamu
      ...
      <header className="container mx-auto px-4 py-4 md:py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <img src={icon} alt="TikDown" className="h-6 w-6 md:h-8 md:w-8 text-pink-500" />
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              <img src={icon} alt="icon" className="h-5 w-5 md:h-6 md:w-6 text-pink-500" />
